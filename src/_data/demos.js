  ...
  groups: [
    ...
    },
    {
      ...
      demos: [
        ...
        { slug: "demo-35-custom-jmod", name: "jlink & jpackage", blurb: "A custom .jmod carrying extra content, linked into a runtime and packaged into an app." },
        { slug: "demo-44-native-image", name: "Native image", blurb: "A GraalVM native binary built end to end, with reachability metadata captured from the tests." },
        { slug: "demo-43-publishing", name: "Publishing", blurb: "A Maven Central ready bundle - POM metadata, sources and javadoc jars - resolved back to prove it." },
        { slug: "demo-46-jpx", name: "Running a released program", blurb: "jpx installs and launches a published tool - named as a module and as a coordinate, pinned and hash-verified." },
      ],
    },
    {
      title: "JVM languages",
    ...
    },
    {
      ...
      demos: [
        ...
        { slug: "demo-42-supply-chain-security", name: "Supply-chain security", blurb: "Strict pinning and checksum verification, proven by getting both wrong on purpose." },
      ],
    },
    {
      ...
      demos: [
        ...
        { slug: "demo-32-platform-guard", name: "Platform guard", blurb: "Selecting a dependency variant per platform." },
        { slug: "demo-33-platform-guard-pom", name: "Platform guard (Maven)", blurb: "The platform guard in a Maven layout." },
      ],
    },
    {
      ...
      demos: [
        ...
        { slug: "demo-34-custom-assembler", name: "Custom assembler", blurb: "Wrapping the stock assembler so sources are preprocessed before they compile." },
        { slug: "demo-38-custom-maven", name: "Custom Maven build", blurb: "Driving a multi-module Maven-layout build from your own entry point with the convenience factory." },
        { slug: "demo-39-custom-modular", name: "Custom modular build", blurb: "The same for a modular project." },
        { slug: "demo-40-custom-build", name: "Custom build", blurb: "A code-generating build graph wired entirely by hand." },
        { slug: "demo-36-internal-module", name: "Internal build module", blurb: "A reusable build plugin compiled from local source." },
        { slug: "demo-37-external-module", name: "External build module", blurb: "The same plugin resolved as a published coordinate." },
        { slug: "demo-41-docker-isolation", name: "Docker isolation", blurb: "Confining the build and the launched program in a throwaway container." },
        { slug: "demo-45-build-cache", name: "Build cache", blurb: "Sharing build outputs through a cache." },
      ],
    },
  ],
};
