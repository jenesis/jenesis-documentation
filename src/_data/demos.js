  ...
  groups: [
    ...
    },
    {
      ...
      demos: [
        ...
        { slug: "demo-36-internal-module", name: "Internal build module", blurb: "A build plug-in compiled from local source." },
        { slug: "demo-37-external-module", name: "External build module", blurb: "The same plug-in resolved as a published coordinate." },
      ],
    },
    {
      ...
      demos: [
        ...
        { slug: "demo-34-custom-assembler", name: "Custom assembler", blurb: "A custom assembly step." },
        { slug: "demo-38-custom-maven", name: "Custom Maven build", blurb: "Customising a Maven-layout build." },
        { slug: "demo-39-custom-modular", name: "Custom modular build", blurb: "Customising a modular build." },
        { slug: "demo-40-custom-build", name: "Custom build", blurb: "A fully custom build definition." },
        { slug: "demo-41-docker-isolation", name: "Docker isolation", blurb: "Running the build isolated in a container." },
