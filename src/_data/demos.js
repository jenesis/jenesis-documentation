  ...
  groups: [
    ...
    },
    {
      ...
      demos: [
        ...
        { slug: "demo-36-kotlin-plugin", name: "Kotlin compiler plugin", blurb: "Enabling a Kotlin compiler plugin." },
        { slug: "demo-37-scala", name: "Scala", blurb: "A Scala (and mixed Java/Scala) project." },
    ...
    },
    {
      ...
      demos: [
        ...
        { slug: "demo-30-test-selection", name: "Test selection", blurb: "Running only the tests a change can affect." },
        { slug: "demo-31-pitest", name: "Mutation testing", blurb: "Mutation testing with PIT, switched on by its configuration file." },
        { slug: "demo-32-jmh", name: "Benchmarks", blurb: "A JMH benchmark the build generates, compiles and runs, printing its result table." },
        { slug: "demo-33-api-compatibility", name: "API compatibility", blurb: "japicmp compares the built jar's byte code against a released one, so a breaking change shows up before you publish it." },
      ],
    },
    {
      ...
      demos: [
        { slug: "demo-25-sbom", name: "SBOM", blurb: "Generating a software bill of materials." },
        { slug: "demo-26-compliance", name: "Dependency licensing", blurb: "Checking dependency licences against policy." },
        { slug: "demo-27-vulnerabilities", name: "Vulnerabilities", blurb: "Scanning dependencies for known vulnerabilities." },
