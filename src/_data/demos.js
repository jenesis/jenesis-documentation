  ...
  groups: [
    ...
    },
    {
      ...
      demos: [
        ...
        { slug: "demo-56-project-plugins", name: "Project plugins", blurb: "Plugins hooked into the build of the whole project: a licence check before anything compiles, a notice attached to every module and checked before staging, a distribution zip beside the stock packages, an exporter that delivers what was staged, and a checksum list run only on demand." },
