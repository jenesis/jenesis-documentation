  ...
  groups: [
    ...
    },
    {
      ...
      demos: [
        ...
        { slug: "demo-59-publishing", name: "Publishing", blurb: "A Maven Central ready bundle - POM metadata, sources and javadoc jars - resolved back to prove it." },
        { slug: "demo-60-module-convention", name: "Your own module repository", blurb: "Modules published to a plain Maven repository and resolved back by module name, with no registry to keep in sync." },
        { slug: "demo-61-reproducible", name: "Reproducible builds", blurb: "A jar checked against a SHA-256 recorded in the demo, on Linux, macOS and Windows in CI." },
        { slug: "demo-62-toolchain", name: "The JDK a build runs on", blurb: "A project names its JDK, and a build started on JDK 25 runs again on 26 in CI on Linux, macOS and Windows." },
        { slug: "demo-63-native-image", name: "Native image", blurb: "A GraalVM native binary built end to end, with reachability metadata captured from the tests." },
        { slug: "demo-64-jpx", name: "Running a released program", blurb: "jpx installs and launches a published tool - named as a module and as a coordinate, pinned and hash-verified." },
      ],
    },
  ],
};
