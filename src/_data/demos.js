  ...
  groups: [
    ...
    },
    {
      ...
      demos: [
        ...
        { slug: "demo-54-custom-maven", name: "Custom Maven build", blurb: "Driving a multi-module Maven-layout build from your own entry point with the convenience factory." },
        { slug: "demo-55-custom-modular", name: "Custom modular build", blurb: "The same for a modular project." },
        { slug: "demo-56-custom-build", name: "Custom build", blurb: "A code-generating build graph wired entirely by hand." },
        { slug: "demo-57-tools-api", name: "Running a build in-process", blurb: "A build, and the program it produced, run inside another program's JVM through java.util.spi.ToolProvider." },
      ],
    },
    {
      title: "Delivery",
      ...
      demos: [
        { slug: "demo-58-code-signing", name: "Code signing", blurb: "The produced jar signed with jarsigner, with the key named by the machine rather than by the project." },
        { slug: "demo-59-export", name: "Exporting to the local repositories", blurb: "A module exported into the local repositories and required from a second project by name, with both repositories in a temporary folder." },
        { slug: "demo-60-publishing", name: "Publishing", blurb: "A Maven Central ready bundle - POM metadata, sources and javadoc jars - resolved back to prove it." },
        { slug: "demo-61-module-convention", name: "Your own module repository", blurb: "Modules published to a plain Maven repository and resolved back by module name, with no registry to keep in sync." },
        { slug: "demo-62-reproducible", name: "Reproducible builds", blurb: "A jar checked against a SHA-256 recorded in the demo, on Linux, macOS and Windows in CI." },
        { slug: "demo-63-toolchain", name: "The JDK a build runs on", blurb: "A project names its JDK, and a build started on JDK 25 runs again on 26 in CI on Linux, macOS and Windows." },
        { slug: "demo-64-native-image", name: "Native image", blurb: "A GraalVM native binary built end to end, with reachability metadata captured from the tests." },
        { slug: "demo-65-jpx", name: "Running a released program", blurb: "jpx installs and launches a published tool - named as a module and as a coordinate, pinned and hash-verified." },
      ],
    },
  ],
};
