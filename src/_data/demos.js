  ...
  groups: [
    ...
    },
    {
      ...
      demos: [
        ...
        { slug: "demo-19-module-classifier", name: "Module classifier", blurb: "Pinning a classified variant of a module." },
        ...
        { slug: "demo-24-platform-guard", name: "Platform guard", blurb: "Selecting a dependency variant per platform." },
        { slug: "demo-25-platform-guard-pom", name: "Platform guard (Maven)", blurb: "The platform guard in a Maven layout." },
      ],
    },
    {
    ...
    },
    {
      ...
      demos: [
        { slug: "demo-45-profiles", name: "Build profiles", blurb: "Switching configuration with profiles." },
    ...
    },
    {
      ...
      demos: [
        ...
        { slug: "demo-59-toolchain", name: "The JDK a build runs on", blurb: "A project names its JDK, and a build started on JDK 25 runs again on 26 in CI on Linux, macOS and Windows." },
        { slug: "demo-60-native-image", name: "Native image", blurb: "A GraalVM native binary built end to end, with reachability metadata captured from the tests." },
        { slug: "demo-61-jpx", name: "Running a released program", blurb: "jpx installs and launches a published tool - named as a module and as a coordinate, pinned and hash-verified." },
      ],
    },
  ],
};
