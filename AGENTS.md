...
| `src/jpx/` | jpx, the module runner | [jenesis/jenesis](https://github.com/jenesis/jenesis) | `sources/build/jenesis/Jpx.java`, `sources/build/jenesis/docker/`, `sdk/jpx/`, `demo/demo-61-jpx` | `java build/jenesis/Jpx.java <target>` from a project that carries `build/jenesis/` |
